...
local function builtin_guides()
    return {
        ...
        },
        {
            ...
            type = 'manual',
            description = 'Repeatable hunt for the Valkurm Emperor lottery camp. CatsEyeXI uses one true Damselfly placeholder, server ID 17199434 (target index 14A).',
...
local function normalize_settings(source)
    ...
    return {
        ...
        valor_opacity = bounded_number(source.valor_opacity, legacy_opacity, DEFAULT_SETTINGS.valor_min_opacity, 100),
...
local function settings_text()
    ...
    local lines = {
        ...
        string.format('    valor_opacity = %d,', bounded_number(state.valor_opacity[1], DEFAULT_SETTINGS.valor_opacity, DEFAULT_SETTINGS.valor_min_opacity, 100)),
...
local function render_valor_config()
    ...
    imgui.SliderInt(
        ...
        state.valor_opacity,
        DEFAULT_SETTINGS.valor_min_opacity,
        100,
        '%d%%');
    imgui.PopItemWidth();
